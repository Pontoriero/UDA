...
// Carica informazioni prova (solo se appartiene al docente)
$stmt = $db->prepare("
...
// Carica tutti gli studenti valutati per questa prova
$stmt = $db->prepare("
...
// Calcola risultati e statistiche
$risultati = [];
$statistiche_criteri = [];
...
foreach ($statistiche_criteri as &$stat) {
...
<head>
    ...
    <title>Report Prova - <?php echo APP_NAME; ?></title>
        ...
        <div class="main-content">
                ...
                <div class="card">
                    <div class="card-body">
                        <p class="text-muted text-center">
                            Nessuno studente valutato per questa prova.<br>
                            <a href="valuta.php?prova_id=<?php echo $prova_id; ?>" class="btn btn-primary" style="margin-top: 15px;">Inizia a Valutare</a>
                        </p>
                    </div>
                </div>
            <?php else: ?>
            ...
            <div class="report-header">
                ...
                <p style="margin: 0; opacity: 0.9;">
                    ...
                    <strong>Studenti Valutati:</strong> <?php echo count($risultati); ?>
                </p>
            </div>

            <!-- Statistiche Generali -->
            <h3 style="margin-bottom: 15px;">📈 Statistiche Classe</h3>
                            ...
                            <tbody>
                                <?php foreach ($risultati as $index => $risultato): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="valuta.php?prova_id=<?php echo $prova_id; ?>&studente_id=<?php echo $studente['id']; ?>" class="btn btn-primary btn-sm">Modifica</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
